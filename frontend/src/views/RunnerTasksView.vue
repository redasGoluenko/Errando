    ...
    <header class="bg-white shadow-md">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-800">Runner Dashboard</h1>
            <p class="text-gray-600 mt-1">View and manage your assigned tasks</p>
          </div>
          <div class="flex items-center gap-3">
            <router-link
              to="/dashboard"
              class="px-4 py-2 text-gray-600 hover:text-gray-800 transition duration-200 flex items-center gap-2"
            >
