                ...
                <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span class="text-2xl font-bold text-gray-900">{{ runner.totalReviews }}</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span class="text-2xl font-bold text-gray-900">{{ runner.activeTasks }}</span>
                    </div>
                  </div>

                  <!-- Task Acceptance Rate -->
                  <div>
                    <p class="text-sm text-gray-600 mb-1">Acceptance Rate</p>
                    <div class="flex items-center gap-2">
                      <svg
                      ...
                      <span class="text-2xl font-bold text-gray-900">{{ runner.taskAcceptanceRate }}%</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span class="text-2xl font-bold text-gray-900">{{ runner.totalTasksAssigned }}</span>
                    </div>
                  </div>
                </div>
              </div>
